...
public class EquipmentReceiveTest {
	@Autowired
	...
	@Test
	public void tdGetAllAttachmentNameById() throws Exception {
		for (int i = 1; i <= datas.size(); i++) {
			mockMvc.perform(MockMvcRequestBuilders.get("/Equipment/getOne")
					.contentType(MediaType.APPLICATION_FORM_URLENCODED)
		    		.param("id", String.valueOf(i)))
	...
	@Test
	public void teGetOneAttachment() throws Exception {
		for (int i = 1; i <= datas.size(); i++) {
			mockMvc.perform(MockMvcRequestBuilders.get("/Equipment/getOne")
					.contentType(MediaType.APPLICATION_FORM_URLENCODED)
		    		.param("id", String.valueOf(i)))
	...
	@Test
	public void tfModifyOne() throws Exception {
    ...
    @Test
	public void tgDeleteOne() throws Exception {
		for (int i = 1; i <= datas.size(); i++) {
			String id = "id=" + i;
