...
CREATE TABLE `staff_authorization` (
  ...
  CONSTRAINT `authorize_user_id` FOREIGN KEY (`authorizer_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `qualifacate_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `staff_qualification` (
  ...
  `qualification_image` varchar(100) DEFAULT NULL,
  `user_id` bigint(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `qualification_user_id` (`user_id`),
  CONSTRAINT `qualification_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staff_qualification` VALUES (1,'2018-06-03 08:50:26','2018-06-03 08:52:08','测试工程师认定签字',NULL,3),(2,'2018-06-03 08:50:48','2018-06-03 08:52:13','合同签订',NULL,4);
...
-- Dump completed on 2018-06-03 16:56:32
