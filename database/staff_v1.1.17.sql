...
CREATE TABLE `staff_file` (
  ...
  CONSTRAINT `file_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `staff_file` VALUES (1,'2018-05-28 05:26:46','2018-05-28 05:27:39','bf757878','1号档案柜',NULL,1),(2,'2018-05-28 05:27:26','2018-05-28 05:27:39','tp5689855','2号档案柜',NULL,2);
...
INSERT INTO `staff_training` VALUES (1,'2018-05-29 13:09:15','2018-05-29 13:09:15','实验室设备使用','2018-05-19',NULL,'南京大学','马云','设备开机与关机',NULL);
...
INSERT INTO `staff_training_result` VALUES (1,'2018-05-29 13:10:16','2018-05-29 13:10:16',1,2,'合格',NULL);
...
-- Dump completed on 2018-05-30 15:47:37
